...
static bool send_image_packets(const uint8_t *image,
  ...
  /* Setup for image transmit. Redundant will send image twice. */
  uint8_t rtx = conf->redundantTx ? 2 : 1;
  do {
