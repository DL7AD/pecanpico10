...
/*===========================================================================*/
/* ChibiOS HAL and Packet System HAL.                                        */
/*===========================================================================*/
...
/*===========================================================================*/
/* Packet System function includes.                                          */
/*===========================================================================*/
 ...
 */
#if PKT_MEMORY_USE_CCM
#define useCCM  __attribute__((section(".ram4")))
#else
#define useCCM
#endif /* PKT_MEMORY_USE_CCM */

/* Maximum length for a thread name (for var based names). */
...
/**
 * @brief   Generalised GPIO handling for optional IO.
 * @notes   If the line is PAL_NOLINE there is no action.
 *
 * @api
 */
