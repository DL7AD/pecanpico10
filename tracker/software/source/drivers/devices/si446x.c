 ...
 *
 */
static uint16_t Si446x_prepareLinkLevelHandler(radio_mod_t mod,
                                               packet_t pp,
...
THD_FUNCTION(Si446x_packetTransmitHandler, arg) {
  ...
  do {
    ...
    uint16_t all = Si446x_prepareLinkLevelHandler(mod, pp, &iterator, &sampler);
    if (all == 0) {
