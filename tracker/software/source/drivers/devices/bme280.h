...
#define BME280_I1	0x0
#define BME280_E1	0x1
#define BME280_E2	0x2
...
// BME280 handle
typedef struct {
	// Functions pointers to the I2C library
	bool (*i2c_read8)(I2CDriver*, uint8_t, uint8_t, uint8_t*);
	bool (*i2c_read16)(I2CDriver*, uint8_t, uint8_t, uint16_t*);
	bool (*i2c_read16_LE)(I2CDriver*, uint8_t, uint8_t, uint16_t*);
	bool (*i2c_write8)(I2CDriver*, uint8_t, uint8_t, uint8_t);
