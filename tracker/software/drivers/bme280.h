...
typedef struct {
	...
	bool (*i2c_read8)(uint8_t,uint8_t,uint8_t*);
	bool (*i2c_read16)(uint8_t,uint8_t,uint16_t*);
	bool (*i2c_read16_LE)(uint8_t,uint8_t,uint16_t*);
	bool (*i2c_write8)(uint8_t,uint8_t,uint8_t);
