...
#else
/* Configuration Descriptor for the serial converter.*/
static const uint8_t vcom_configuration_descriptor_data[42] = {
  /* Configuration Descriptor.*/
...
static const uint8_t vcom_string2[] = {
  ...
  USB_DESC_BYTE(USB_DESCRIPTOR_STRING), /* bDescriptorType.                 */
  'F', 0, 'T', 0, '2', 0, '3', 0, '0', 0, 'X', 0, ' ', 0, 'B', 0,
  'A', 0, 'S', 0, 'I', 0, 'C', 0, ' ', 0, 'U', 0, 'A', 0, 'R', 0, 'T', 0
#else
...
static const uint8_t vcom_string3[] = {
  ...
  USB_DESC_BYTE(USB_DESCRIPTOR_STRING), /* bDescriptorType.                 */
  'A', 0, '5', 0, '0', 0, '2', 0, '8', 0, '5', 0, 'B', 0, 'I', 0
#else
